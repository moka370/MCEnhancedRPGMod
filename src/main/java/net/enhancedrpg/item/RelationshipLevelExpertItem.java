...
import net.enhancedrpg.item.inventory.RelationshipLevelExpertInventoryCapability;
...
public class RelationshipLevelExpertItem extends Item {
	public RelationshipLevelExpertItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Relationship Level: Expert");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new ExpertLevelMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new RelationshipLevelExpertInventoryCapability();
	}
