...
import net.enhancedrpg.item.inventory.RelationshipLevelApprInventoryCapability;
...
public class RelationshipLevelApprItem extends Item {
	public RelationshipLevelApprItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Relationship Level: Apprentice");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new ApprenticeLevelMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new RelationshipLevelApprInventoryCapability();
	}
