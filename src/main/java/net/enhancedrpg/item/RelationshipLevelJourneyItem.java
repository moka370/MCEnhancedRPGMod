...
import net.enhancedrpg.item.inventory.RelationshipLevelJourneyInventoryCapability;
...
public class RelationshipLevelJourneyItem extends Item {
	public RelationshipLevelJourneyItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Relationship Level: Journeyman");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new JourneyLevelMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new RelationshipLevelJourneyInventoryCapability();
	}
